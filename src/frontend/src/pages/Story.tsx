...
/**
 * Handles all of the story logic
 * @returns main webpage which contains stories, share button and the carousel
 */
function Story() {
  ...
  const pages = [
    ...
    //Setup variables for the management of the stories
    const numReps = pages.length;
    //Length of each story in ms
    const storyLength = 10000;
  ...
  useEffect(() => {
    ...
    function runStory() {
        ...
        /**
         * Handles the creation and visualisation of progress through stories
         * @returns an array of JSX elements which make up the story bar
         */
        function StoryBars() {
  ...
  function handleRightClick() {
    goRight();
        ...
        /**
         * Handles pausing of the stories, changing the icon shown by the button
         * @returns a button element which calls the @function play when clicked
         */
        function PButton() {
        ...
        //Handles the muting (for later implementation)
        function MButton() {
